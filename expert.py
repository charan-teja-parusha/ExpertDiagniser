...
def suggest_disease(disease, symptoms):
    ...
    if open_doc == "yes":
        print(os.getcwd())
        url = 'file:///'+os.getcwd()+'/Treatment/html/'+disease+'.html'
        print(url)
        webbrowser.open(url,new=2)
        #webbrowser.open("file:///"+os.getcwd()+"/Treatment/html/{disease}.html")
    exit(0)
...
class MedicalExpert(KnowledgeEngine):
    ...
    def askArthritis(self):
        ...
        red_skin_around_joint=yes_no("Did the skin turn red around the Joinyets?")
